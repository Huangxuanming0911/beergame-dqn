...
def run(name, shaping_cfg, seed=42):
...
if __name__ == "__main__":
    run("baseline", {})
    run("ext1", {"use_externality_shaping": True, "externality_coef": 1.0})
    run("smooth01", {"use_action_smoothing": True, "action_smooth_coef": 0.1})
    run("both", {"use_externality_shaping": True, "externality_coef": 1.0,
                 "use_action_smoothing": True, "action_smooth_coef": 0.1})
